...
define( 'WPLC_PARTNER_ID', 'woocommerce' );
define( 'WPLC_UTM_CAMPAIGN', 'woocommerce_integration' );
define( 'WPLC_PLUGIN_SLUG', 'livechat-woocommerce' );
define( 'WPLC_PLUGIN_MAIN_FILE', WPLC_PLUGIN_SLUG . '/woocommerce-livechat.php' );
